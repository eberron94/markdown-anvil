...
Attempt a check using Arcana against the highest piloting DC. The GM may adjust the DC based on the situation or the elemental's memories.

**Critical Success** For the next 10 minutes, you can pilot the vehicle with whichever skill the vehicle can use. The DC increase from lacking the correct dragonmark is reduced by your level, to a minimum of 0.
