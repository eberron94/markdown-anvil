...
**Speed** 10 feet, burrow 5 feet (elemental)
...
**Expressed Nature** The bound earth elemental is allowed to express its true nature with the {title}. The pilot does not need a dragonmark to control the craft, but all actions to move the vehicle gain the linguistic trait and the pilot must speak kythric. The DC is unchanged and Driving Lore can be used for the piloting check.
